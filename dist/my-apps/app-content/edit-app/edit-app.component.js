...
var EditAppComponent = (function () {
    ...
    EditAppComponent.prototype.ngOnInit = function () {
        ...
        if (!!this.app.allowsOrigins && this.app.allowsOrigins.length > 0) {
            allowAllOrigins = this.app.allowsOrigins[0]["id"] === Carbon_1.Carbon.NS.CS.Class.AllOrigins;
            if (!allowAllOrigins)
    ...
    EditAppComponent.prototype.onSubmit = function (form, $event) {
        ...
        if (allowsAllOrigins) {
            this.app.allowsOrigins = [Carbon_1.Carbon.Pointer.Factory.create(Carbon_1.Carbon.NS.CS.Class.AllOrigins)];
        }
        else {
