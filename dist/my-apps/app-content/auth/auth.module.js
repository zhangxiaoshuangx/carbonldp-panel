System.register(["@angular/core", '@angular/common', "@angular/forms", "./auth.routing", "./auth.view", "./agents/agents.view", "./agents/agents.component", "./agents/agents-list/agents-list.view", "./agents/agents-list/agents-list.component", "./agents/agent-details/agent-details.view", "./agents/agent-details/agent-details.component", "./agents/agent-deleter/agent-deleter.component", "./agents/agent-creator/agent-creator.view", "./agents/agent-not-found/agent-not-found.view", "./roles/roles.view", "./roles/roles-list/roles-list.view", "./roles/roles-list/roles-list.component", "./roles/role-details/role-details.view", "./roles/roles-chooser/roles-chooser.component", "carbonldp-panel/panel.module", "carbonldp-panel/directives.module", "./agents/agents.service", "./roles/roles.service", "./agents/agent.resolver", "./roles/role.resolver"], function(exports_1, context_1) {
    "use strict";
