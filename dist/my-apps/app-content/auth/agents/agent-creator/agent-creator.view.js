System.register(["@angular/core", "@angular/common", "@angular/router", "carbonldp-panel/my-apps/app-content/app-content.service", "carbonldp-panel/my-apps/app-content/auth/agents/agent-details/agent-details.component", "./agent-creator.view.html!"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, router_1, app_content_service_1, agent_details_component_1, agent_creator_view_html_1;
    var AgentCreatorView;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            function (agent_creator_view_html_1_1) {
                agent_creator_view_html_1 = agent_creator_view_html_1_1;
            }],
        execute: function() {
            AgentCreatorView = (function () {
            ...
            exports_1("AgentCreatorView", AgentCreatorView);
            exports_1("default",AgentCreatorView);
        }
    }
});
