...
export declare class RolesService {
    ...
    delete(appContext: App.Context, roleID: string): Promise<HTTP.Response.Class>;
    ...
    getDescendants(appContext: App.Context, roleID?: string): Promise<PersistedRole.Class[]>;
