System.register(["@angular/core", "carbonldp/Carbon", "carbonldp/Utils", "carbonldp/RDF/URI", "carbonldp/NS", "carbonldp-panel/my-apps/app-content/app-content.service"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Carbon_1, Utils, URI, NS, app_content_service_1;
    var AgentsService;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AgentsService = (function () {
                ...
                AgentsService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [Carbon_1.default, app_content_service_1.AppContentService])
                ], AgentsService);
