System.register(["@angular/core", '@angular/common', "@angular/forms", "./security.routing", "./security.view", "./agents/agents.view", "./agents/agents.component", "./agents/agents-list/agents-list.view", "./agents/agents-list/agents-list.component", "./agents/agent-details/agent-details.view", "./agents/agent-details/agent-details.component", "./agents/agent-deleter/agent-deleter.component", "./agents/agent-creator/agent-creator.view", "./agents/agent-not-found/agent-not-found.view", "./roles/roles.view", "./roles/roles-catalog/roles-catalog.view", "./roles/roles-catalog/roles-catalog.component", "./roles/roles-list/roles-list.component", "./roles/roles-browser/roles-browser.component", "./roles/roles-tree-view/roles-tree-view.component", "./roles/role-details/role-details.view", "./roles/role-details/role-details.component", "./roles/roles-chooser/roles-chooser.component", "carbonldp-panel/panel.module", "carbonldp-panel/directives.module", "./agents/agents.service", "./roles/roles.service", "./agents/agent.resolver", "./roles/role.resolver"], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        setters:[
            ...
            function (roles_catalog_component_1_1) {
                roles_catalog_component_1 = roles_catalog_component_1_1;
            },
            function (roles_list_component_1_1) {
                roles_list_component_1 = roles_list_component_1_1;
            },
                ...
                SecurityModule = __decorate([
                    core_1.NgModule({
                        ...
                        declarations: [
                            ...
                            roles_catalog_view_1.RolesCatalogView,
                            roles_catalog_component_1.RolesCatalogComponent,
                            ...
                            role_details_view_1.RoleDetailsView,
