...
var CreateAppComponent = (function () {
    ...
    CreateAppComponent.prototype.onSubmit = function (form, $event) {
        ...
        appDocument.allowsOrigins = [Carbon_1.Carbon.Pointer.Factory.create(Carbon_1.Carbon.NS.CS.Class.AllOrigins)];
...
CreateAppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [Carbon_1.Carbon, app_context_service_1.AppContextService, router_1.Router, messages_area_service_1.MessagesAreaService])
], CreateAppComponent);
