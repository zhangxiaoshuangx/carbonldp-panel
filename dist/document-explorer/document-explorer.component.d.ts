...
export declare class DocumentExplorerComponent {
    ...
    changeSelection(documentURI: string): void;
    onSuccessAccessPoint($event: any): void;
    onSuccessCreateDocument($event: any): void;
    onSuccessDeleteDocument($event: any): void;
    handleExternalError(error: HTTPError): void;
}
