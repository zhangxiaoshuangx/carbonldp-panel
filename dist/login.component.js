System.register(["@angular/core", "@angular/forms", "angular2-carbonldp/services", "carbonldp/HTTP", "carbon-panel/custom-validators", "jquery", "semantic-ui/semantic", "./login.component.html!"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, forms_1, services_1, HTTP, custom_validators_1, jquery_1, login_component_html_1;
    var LoginComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            LoginComponent = (function () {
                ...
                LoginComponent.prototype.shakeForm = function () {
                    var target = this.$element.find(".formContainer");
                    if (this.container) {
                        target = jquery_1.default(this.container);
                    }
                    if (target) {
                        target.transition({
                            animation: "shake",
                ...
                LoginComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [forms_1.NgForm, custom_validators_1.EmailValidator, custom_validators_1.PasswordValidator],
                    }),
